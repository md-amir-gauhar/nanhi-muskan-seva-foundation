...
const donationSchema = z.object({
  ...
  amount: z.number().min(100, "Minimum donation amount is ₹100").max(10000000, "Maximum donation amount is ₹1,00,00,000"),
});
        ...
        >
          ...
          <div className="gradient-hero p-6 rounded-t-3xl relative">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <p className="text-primary-foreground/80 text-sm font-body">Donating to</p>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div>
              ...
              {errors.amount && (
                <p className="text-destructive text-sm mt-1 font-body">{errors.amount}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.phone && (
                <p className="text-destructive text-sm mt-1 font-body">{errors.phone}</p>
              )}
            </div>
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  ...
                  Donate {formData.amount ? `₹${formatCurrency(parseInt(formData.amount))}` : "Now"}
                </>
              )}
            </Button>
